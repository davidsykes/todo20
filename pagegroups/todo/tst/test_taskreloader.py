...
class TestClassToTest(unittest.TestCase):
    ...
    def test_reload_tasks_passes_godaddy_tasks_to_godaddy_task_merger(self):
        self.task_reloader.reload_tasks()
        self.mock_godaddy_task_merger.merge_godaddy_tasks.assert_called_once_with(self.godaddy_tasks)
    ...
    def set_up_mocks(self):
        ...
        self.mock_godaddy_task_merger = MagicMock()
        self.factory.register('GoDaddyTaskMerger', self.mock_godaddy_task_merger)
